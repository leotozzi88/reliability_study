...
for sub=1:length(subs)
    ...
    csvwrite(strcat(edges_outputpath, '/RSNavg1.csv'), allnws1)
    csvwrite(strcat(edges_outputpath, '/RSNavg2.csv'), allnws2)


% Now compute the ICC for these values

t1=csvread(strcat(edges_outputpath, '/RSNavg1.csv'));
t2=csvread(strcat(edges_outputpath, '/RSNavg2.csv'));
...
for sub=1:length(subs)
    ...
    csvwrite(strcat(edges_outputpath, '/RSNavg1_gsr.csv'), allnws1)
    csvwrite(strcat(edges_outputpath, '/RSNavg2_gsr.csv'), allnws2)

% Now compute the ICC for these values

t1=csvread(strcat(edges_outputpath, '/RSNavg1_gsr.csv'));
t2=csvread(strcat(edges_outputpath, '/RSNavg2_gsr.csv'));
