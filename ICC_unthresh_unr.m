...
for atlas=1:length(atlases)
    ...
    csvwrite(strcat(edges_outputpath, '/', atlases{atlas}, '_edgw1_unr.csv'), alledgw1)
    csvwrite(strcat(edges_outputpath, '/', atlases{atlas}, '_edgw2_unr.csv'), alledgw2)
    
    csvwrite(strcat(edges_outputpath, '/', atlases{atlas}, '_edgw1_gsr_unr.csv'), alledgw1_gsr)
    csvwrite(strcat(edges_outputpath, '/', atlases{atlas}, '_edgw2_gsr_unr.csv'), alledgw2_gsr)
    ...
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_unr.csv'), iccall)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_lvls_unr.csv'), icclevelsnoGSR)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_lvls_alt_unr.csv'), icclevelsnoGSR_alt)

    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_gsr_unr.csv'), iccall_gsr)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_lvls_gsr_unr.csv'), icclevelsGSR)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_lvls_gsr_alt_unr.csv'), icclevelsGSR_alt)
    
    % Save p-values and boundaries
    
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_p_unr.csv'), pall)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_p_gsr_unr.csv'), pall_gsr)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_ib_unr.csv'), lball)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_ib_gsr_unr.csv'), lball_gsr)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_ub_unr.csv'), uball)
    csvwrite(strcat(ICC_outputpath, '/', 'ICC_', atlases{atlas}, '_edgw1_ub_gsr_unr.csv'), uball_gsr)
...
% Plot results
% Loading BNT data
icc_bnt=csvread(strcat(ICC_outputpath, '/ICC_BNT_edgw1_unr.csv'));
icc_bnt_gsr=csvread(strcat(ICC_outputpath, '/ICC_BNT_edgw1_gsr_unr.csv'));
ICC_BNT_lvls=csvread(strcat(ICC_outputpath, '/', 'ICC_BNT_edgw1_lvls_unr.csv'));
ICC_BNT_lvls_gsr=csvread(strcat(ICC_outputpath, '/', 'ICC_BNT_edgw1_lvls_gsr_unr.csv'));

% Loading Glasser data
icc_gla=csvread(strcat(ICC_outputpath, '/ICC_glasser_edgw1_unr.csv'));
icc_gla_gsr=csvread(strcat(ICC_outputpath, '/ICC_glasser_edgw1_gsr_unr.csv'));
ICC_glasser_lvls=csvread(strcat(ICC_outputpath, '/', 'ICC_glasser_edgw1_lvls_unr.csv'));
ICC_glasser_lvls_gsr=csvread(strcat(ICC_outputpath, '/', 'ICC_glasser_edgw1_lvls_gsr_unr.csv'));

% Loading Gordon data
icc_gor=csvread(strcat(ICC_outputpath, '/ICC_gordon_edgw1_unr.csv'));
icc_gor_gsr=csvread(strcat(ICC_outputpath, '/ICC_gordon_edgw1_gsr_unr.csv'));
ICC_gordon_lvls=csvread(strcat(ICC_outputpath, '/', 'ICC_gordon_edgw1_lvls_unr.csv'));
ICC_gordon_lvls_gsr=csvread(strcat(ICC_outputpath, '/', 'ICC_gordon_edgw1_lvls_gsr_unr.csv'));
...
ICC_BNT_lvls=csvread(strcat(ICC_outputpath, '/', 'ICC_BNT_edgw1_lvls_alt_unr.csv'));
ICC_BNT_lvls_gsr=csvread(strcat(ICC_outputpath, '/', 'ICC_BNT_edgw1_lvls_gsr_alt_unr.csv'));
ICC_glasser_lvls=csvread(strcat(ICC_outputpath, '/', 'ICC_glasser_edgw1_lvls_alt_unr.csv'));
ICC_glasser_lvls_gsr=csvread(strcat(ICC_outputpath, '/', 'ICC_glasser_edgw1_lvls_gsr_alt_unr.csv'));
ICC_gordon_lvls=csvread(strcat(ICC_outputpath, '/', 'ICC_gordon_edgw1_lvls_alt_unr.csv'));
ICC_gordon_lvls_gsr=csvread(strcat(ICC_outputpath, '/', 'ICC_gordon_edgw1_lvls_gsr_alt_unr.csv'));
