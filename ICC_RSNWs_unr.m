...
csvwrite(strcat(ICC_outputpath, '/ICC_RSN_gordon_ub_unr.csv'), alllb)
csvwrite(strcat(ICC_outputpath, '/ICC_RSN_gordon_lb_unr.csv'), allub)
...
csvwrite(strcat(ICC_outputpath, '/ICC_RSN_gordon_ub_gsr_unr.csv'), alllb_gsr)
csvwrite(strcat(ICC_outputpath, '/ICC_RSN_gordon_lb_gsr_unr.csv'), allub_gsr)
