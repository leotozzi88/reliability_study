% Calculating ICC for unthresholded matrices
...
% Paths
matpath='/Users/leonardotozzi/Desktop/Repeatability_study/Connmats';
...
for atlas=1:length(atlases)
    ...
    ICC_minicc=min(iccall,[], 2);
    ICC_maxicc=max(iccall,[], 2);
    
    icclevelsnoGSR=[ICC_poor_nogsr ICC_fair_nogsr ICC_good_nogsr ICC_excellent_nogsr ICC_medianicc_nogsr ICC_minicc ICC_maxicc];
